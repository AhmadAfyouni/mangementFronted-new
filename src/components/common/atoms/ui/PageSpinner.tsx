...
const PageSpinner = ({ size = "medium" }: PageSpinnerProps) => {
  ...
  // Full page overlay spinner for medium/large sizes using portal
  if (typeof window !== "undefined") {
    return createPortal(
      <div className="fixed inset-0 bg-black/20 backdrop-blur-[1px] flex justify-center items-center z-[9999]">
